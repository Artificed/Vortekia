...
use crate::{
    m20250225_065344_create_customers::Customer, m20250226_042701_create_store::Store,
    m20250226_043305_create_souvenir::Souvenir,
};
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(string(StoreTransaction::StoreId).not_null())
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_create_store_transaction_store_id")
                            .from(StoreTransaction::Table, StoreTransaction::StoreId)
